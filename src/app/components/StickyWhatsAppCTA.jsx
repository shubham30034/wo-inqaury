...
export default function StickyWhatsAppCTA() {
  ...
  return (
    <motion.div
      // Isko fixed bottom par rakha hai aur z-index maximum (9999) kar diya hai
    ...
    >
      ...
      <div className="absolute inset-0 rounded-full bg-[#22c55e] blur-xl opacity-40 animate-pulse" />
      ...
      <motion.a
        ...
        className="
          ...
          bg-[#22c55e] text-black rounded-full
      ...
      >
        {/* WhatsApp Icon */}
        <svg className="w-7 h-7 sm:w-8 sm:h-8 mb-0.5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <span className="text-[8px] sm:text-[10px] font-black uppercase leading-none text-center">
          Free Trial
        </span>
      </motion.a>
    </motion.div>
