  ...
  return (
    <section className="relative py-20 bg-[#050505] overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full pointer-events-none">
        <div className="absolute top-0 right-1/4 w-64 h-64 bg-[#22c55e] opacity-[0.03] blur-[100px] rounded-full" />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-14">
          ...
          <h2 className="text-3xl sm:text-4xl font-[1000] text-white tracking-tighter uppercase italic">
            Trusted by <span className="text-[#22c55e]">the Community</span>
          </h2>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {reviews.map((review, i) => (
            <motion.div
              ...
              className="relative p-6 rounded-[1.5rem] border border-white/5 bg-white/[0.02] hover:bg-white/[0.04] transition-all duration-300"
            >
              {/* Google Icon Badge */}
              ...
              <div className="flex flex-col h-full">
                ...
                <div className="mt-auto flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#22c55e]/20 to-emerald-500/20 flex items-center justify-center text-[10px] font-black text-[#22c55e] border border-[#22c55e]/20">
                  ...
                  <div>
                    ...
                    <p className="text-[#22c55e] text-[9px] font-bold uppercase tracking-widest">
        ...
        <div className="mt-12 text-center">
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white/5 border border-white/10 text-white/60 hover:text-white hover:bg-white/10 transition-all text-xs font-bold uppercase tracking-widest"
          >
